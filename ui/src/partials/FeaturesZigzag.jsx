      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">Revolutionizing Consumer Analytics</h1>
            <p className="text-xl text-gray-400">We've developed a ground-breaking paradigm for predicting behavior at the intersection of Artificial Intelligence and Behavioral Economics</p>
          </div>
